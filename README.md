# cas-notarize-docker-image-bom-github-action

GitHub action that uses the **[cas](https://cas.codenotary.com)** tool to notarize docker images and generate a SBOM for them.
